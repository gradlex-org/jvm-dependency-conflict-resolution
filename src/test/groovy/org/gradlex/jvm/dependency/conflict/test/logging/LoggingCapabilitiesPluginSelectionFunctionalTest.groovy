package org.gradlex.jvm.dependency.conflict.test.logging
...
""")
        ...
        result.output.contains("conflict on capability 'org.gradlex:slf4j-impl:1.0'") || result.output.contains("Both provide capability 'org.gradlex:slf4j-impl:1.0'")
    }
