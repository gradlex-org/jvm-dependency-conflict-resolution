...
import org.gradlex.javaecosystem.capabilities.JavaEcosystemCapabilitiesBasePlugin
...
class RulesModeTest extends Specification {
    ...
    def "applying the plugin in a project with rulesMode set to FAIL_ON_PROJECT_RULES fails the build"() {
        ...
        result.output.contains("Fix this problem by either changing dependencyResolutionManagement.rulesMode to PREFER_PROJECT or by applying '${JavaEcosystemCapabilitiesBasePlugin.PLUGIN_ID}' as a settings plugin")
    }
