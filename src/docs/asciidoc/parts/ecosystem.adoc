...
The plugin will verify that the rules from the <<base-plugin,base plugin>> are available either through the central declaration mechanism or through the project's own rules.
