...
1. Maybe there is a mistake/bug in this plugin. Please https://github.com/gradlex-org/jvm-dependency-conflict-resolution/blob/main/issues/new[open an issue] to discuss it.
