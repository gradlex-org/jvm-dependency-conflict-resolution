...
This can be expressed in a compact way if you also use the <<resolution-plugin,`jvm-ecosystem-conflict-resolution`>> plugin. For example:
...
If you do not want to use the <<resolution-plugin,`jvm-ecosystem-conflict-resolution`>> plugin, you can use Gradle's general Component Metadata Rule API.
