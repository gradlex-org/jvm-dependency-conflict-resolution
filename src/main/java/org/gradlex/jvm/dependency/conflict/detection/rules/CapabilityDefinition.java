...
public enum CapabilityDefinition {
    ...
    ASM(HIGHEST_VERSION, "asm:asm", "org.ow2.asm:asm"),
    BOUNCYCASTLE_BCMAIL(
            HIGHEST_VERSION,
            BouncyCastleRule.class,
    ...
    C3P0(HIGHEST_VERSION, "c3p0:c3p0", "com.mchange:c3p0"),
    MCHANGE_COMMONS_JAVA(HIGHEST_VERSION, "c3p0:c3p0", "com.mchange:mchange-commons-java"),
    CGLIB(HIGHEST_VERSION, "cglib:cglib", "cglib:cglib-nodep"),
    COMMONS_BEANUTILS(
            HIGHEST_VERSION, "commons-beanutils:commons-beanutils-core", "commons-beanutils:commons-beanutils"),
    COMMONS_IO(HIGHEST_VERSION, "commons-io:commons-io", "org.apache.commons:commons-io"),
    DK_BRICS_AUTOMATON(HIGHEST_VERSION, "dk.brics.automaton:automaton", "dk.brics:automaton"),
    DOM4J(HIGHEST_VERSION, "dom4j:dom4j", "org.dom4j:dom4j"),
    ...
    GOOGLE_COLLECTIONS(
            ...
            CapabilityDefinitionRule.class,
    ...
    LISTENABLEFUTURE(
            FIRST_MODULE,
            "com.google.guava",
            GuavaListenableFutureRule.class,
            "com.google.guava:guava",
            "com.google.guava:listenablefuture"),
    HAMCREST_LIBRARY(FIRST_MODULE, "org.hamcrest:hamcrest", "org.hamcrest:hamcrest-library"),
    HAMCREST_CORE(FIRST_MODULE, "org.hamcrest:hamcrest", "org.hamcrest:hamcrest-core"),
    HIKARI_CP(HIGHEST_VERSION, "com.zaxxer:HikariCP", "com.zaxxer:HikariCP-java6", "com.zaxxer:HikariCP-java7"),
    INTELLIJ_ANNOTATIONS(HIGHEST_VERSION, "org.jetbrains:annotations", "com.intellij:annotations"),
    ITEXT(HIGHEST_VERSION, "itext:itext", "com.lowagie:itext", "com.github.librepdf:openpdf"),
    JAVA_ASSIST(HIGHEST_VERSION, "javassist:javassist", "org.javassist:javassist", "jboss:javassist"),
    JCIP_ANNOTATIONS(HIGHEST_VERSION, "net.jcip:jcip-annotations", "com.github.stephenc.jcip:jcip-annotations"),
    JNA_PLATFORM(
            HIGHEST_VERSION,
            "net.java.dev.jna:platform",
            "net.java.dev.jna:jna-platform",
            "net.java.dev.jna:jna-platform-jpms"),
    JNA(HIGHEST_VERSION, "net.java.dev.jna:jna", "net.java.dev.jna:jna-jpms", "org.elasticsearch:jna"),
    JTS_CORE(HIGHEST_VERSION, "com.vividsolutions:jts", "com.vividsolutions:jts-core"),
    JUNIT(HIGHEST_VERSION, "junit:junit", "junit:junit-dep"),
    MIGLAYOUT(HIGHEST_VERSION, "com.miglayout:miglayout-swing", "com.miglayout:miglayout"),
    /**
     * See <a href="https://github.com/spring-projects/spring-boot/issues/32881">spring-projects/spring-boot/issues/32881</a>
     */
    ORG_JSON(HIGHEST_VERSION, "com.vaadin.external.google:android-json", "org.json:json"),
    MYSQL_CONNECTOR_JAVA(HIGHEST_VERSION, "mysql:mysql-connector-java", "com.mysql:mysql-connector-j"),
    POSTGRESQL(HIGHEST_VERSION, "postgresql:postgresql", "org.postgresql:postgresql"),
    STAX_API(HIGHEST_VERSION, "stax:stax-api", "javax.xml.stream:stax-api"),
    VELOCITY(
            HIGHEST_VERSION,
            "velocity:velocity",
    ...
    JAKARTA_ACTIVATION_API(
            HIGHEST_VERSION,
            JakartaActivationApiRule.class,
            "jakarta.activation:jakarta.activation-api",
            "com.sun.activation:jakarta.activation"),
    JAKARTA_ANNOTATION_API(
            HIGHEST_VERSION,
            JakartaAnnotationApiRule.class,
            "jakarta.annotation:jakarta.annotation-api",
            "org.apache.tomcat:tomcat-annotations-api"),
    JAKARTA_JSON_API(HIGHEST_VERSION, "jakarta.json:jakarta.json-api", "org.glassfish:jakarta.json"),
    JAKARTA_MAIL_API(
            HIGHEST_VERSION,
            JakartaMailApiRule.class,
    ...
    JAKARTA_WEBSOCKET_CLIENT_API(
            HIGHEST_VERSION,
            JakartaWebsocketClientApiRule.class,
    ...
    JAVAX_EJB_API(
            HIGHEST_VERSION,
            JavaxEjbApiRule.class,
            "jakarta.ejb:jakarta.ejb-api",
            "javax.ejb:javax.ejb-api",
            "javax.ejb:ejb-api"),
    JAVAX_EL_API(
            HIGHEST_VERSION,
            JavaxElApiRule.class,
            "javax.el:el-api",
            "jakarta.el:jakarta.el-api",
            "javax.el:javax.el-api"),
    JAVAX_INJECT_API(
            HIGHEST_VERSION,
            JavaxInjectApiRule.class,
    ...
    JAVAX_JSON_API(
            HIGHEST_VERSION,
            JavaxJsonApiRule.class,
            "javax.json:javax.json-api",
            "jakarta.json:jakarta.json-api",
            "org.glassfish:javax.json",
            "org.glassfish:jakarta.json"),
    JAVAX_JWS_API(HIGHEST_VERSION, JavaxJwsApisRule.class, "javax.jws:javax.jws-api", "jakarta.jws:jakarta.jws-api"),
    JAVAX_MAIL_API(
            HIGHEST_VERSION,
            JavaxMailApiRule.class,
    ...
    JAVAX_VALIDATION_API(
            HIGHEST_VERSION,
            JavaxValidationApiRule.class,
            "javax.validation:validation-api",
            "jakarta.validation:jakarta.validation-api"),
    JAVAX_WEBSOCKET_API_RULE(
            HIGHEST_VERSION,
            JavaxWebsocketApiRule.class,
            "javax.websocket:javax.websocket-api",
            "jakarta.websocket:jakarta.websocket-api",
            "javax.websocket:javax.websocket-client-api", // in javax namespace, websocket-api and websocket-client-api
            // overlap
            "jakarta.websocket:jakarta.websocket-client-api",
            "org.apache.tomcat:tomcat-websocket-api",
            "org.apache.tomcat.embed:tomcat-embed-websocket",
    ...
    JAVAX_XML_BIND_API(
            HIGHEST_VERSION,
            JavaxXmlBindApiRule.class,
            "javax.xml.bind:jaxb-api",
            "jakarta.xml.bind:jakarta.xml.bind-api"),
    JAVAX_XML_WS_API(
            HIGHEST_VERSION, JavaxXmlWsApiRule.class, "javax.xml.ws:jaxws-api", "jakarta.xml.ws:jakarta.xml.ws-api"),
    JAKARTA_JWS_API(
            HIGHEST_VERSION,
            JakartaJwsApiRule.class,
     ...
     */
    LOG4J2_IMPL(NONE, LoggingModuleIdentifiers.LOG4J_TO_SLF4J.moduleId, LoggingModuleIdentifiers.LOG4J_CORE.moduleId),
     ...
     */
    COMMONS_LOGGING_IMPL(
            NONE,
            FixedVersionCapabilityDefinitionRule.class,
    ...
    SLF4J_VS_JCL(NONE, LoggingModuleIdentifiers.JCL_OVER_SLF4J.moduleId, LoggingModuleIdentifiers.SLF4J_JCL.moduleId),
    SLF4J_VS_LOG4J2_FOR_JCL(
            NONE,
            FixedVersionCapabilityDefinitionRule.class,
            LoggingModuleIdentifiers.JCL_OVER_SLF4J.moduleId,
     ...
     */
    SLF4J_VS_LOG4J(
            NONE, LoggingModuleIdentifiers.LOG4J_OVER_SLF4J.moduleId, LoggingModuleIdentifiers.SLF4J_LOG4J12.moduleId),
    SLF4J_VS_LOG4J2_FOR_LOG4J(
            NONE,
            FixedVersionCapabilityDefinitionRule.class,
     ...
     */
    SLF4J_VS_JUL(NONE, LoggingModuleIdentifiers.JUL_TO_SLF4J.moduleId, LoggingModuleIdentifiers.SLF4J_JDK14.moduleId),
    SLF4J_VS_LOG4J2_FOR_JUL(
            NONE,
            FixedVersionCapabilityDefinitionRule.class,
    ...
    CapabilityDefinition(
            DefaultResolutionStrategy defaultStrategy,
            Class<? extends CapabilityDefinitionRule> ruleClass,
            String... modules) {
