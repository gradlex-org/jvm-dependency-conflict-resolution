...
@CacheableRule
@NonNullApi
public abstract class JavaxJsonApiRule implements ComponentMetadataRule {

    public static final String CAPABILITY_GROUP = "javax.json";
    public static final String CAPABILITY_NAME = "javax.json-api";
