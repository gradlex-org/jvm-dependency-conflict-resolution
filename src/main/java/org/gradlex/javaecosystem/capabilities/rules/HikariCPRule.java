...
@CacheableRule
@NonNullApi
public abstract class HikariCPRule implements ComponentMetadataRule {

    public static final String CAPABILITY_GROUP = "com.zaxxer";
    public static final String CAPABILITY_NAME = "HikariCP";
