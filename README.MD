...
1. Maybe there is a mistake/bug in this plugin. Please [open an issue](https://github.com/jjohannes/java-ecosystem-capabilities/blob/main/issues/new) to discuss it.
