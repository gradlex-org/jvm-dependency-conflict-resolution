...
dependencies {
    ...
    implementation("org.apache.tomcat:tomcat-annotations-api:11.0.8")
    implementation("org.apache.tomcat:tomcat-servlet-api:11.0.8")
    implementation("org.apache.tomcat:tomcat-websocket-api:11.0.8")
